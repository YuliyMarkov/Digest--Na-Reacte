  ...
  return (
    <header className="header">
      <div className="container header-container">
        ...
        >
          <Link to={`/${language}/category/uzbekistan`} onClick={closeMenu}>
            {t.categories.uzbekistan}
          </Link>
          <Link to={`/${language}/category/world`} onClick={closeMenu}>
            {t.categories.world}
          </Link>
          <Link to={`/${language}/category/auto`} onClick={closeMenu}>
            {t.categories.auto}
          </Link>
          <Link to={`/${language}/category/incidents`} onClick={closeMenu}>
            {t.categories.incidents}
          </Link>
          <Link to={`/${language}/category/science`} onClick={closeMenu}>
            {t.categories.science}
          </Link>
          <Link to={`/${language}/category/economy`} onClick={closeMenu}>
